...
/**
 * test Queue type RingBuffer.
 */

public class RingBufferAsQueueTest {
    ...
    public void readingFromEmptyBufferShouldThrowException() throws RingBufferIOException {
        RingBuffer<Integer> buffer = RingBuffer.ofTypeAndSize(RingBuffer.Type.Queue, 1);
    ...
    public void readsItemsInOrderWritten() throws RingBufferIOException {
        RingBuffer<Integer> buffer = RingBuffer.ofTypeAndSize(RingBuffer.Type.Queue, 2);
    ...
    public void maintainsReadPositionAcrossWrites() throws RingBufferIOException {
        RingBuffer<Integer> buffer = RingBuffer.ofTypeAndSize(RingBuffer.Type.Queue, 3);
